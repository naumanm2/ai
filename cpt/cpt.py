...
def get_conditional_probability(data, query, conditions):
    ...
    qc = query.update(conditions)
    return get_data_frequency(data, {**query, **conditions}) / (get_data_frequency(data, conditions) + epsilon)
    # =========================================================
...
def exhaustive_enum(G, X, E, e):
    ...
    for assignment in assignments:
        ...
        for node in G.nodes:
            ...
            # CODE HERE!
            # =========================================================
            tmp = tmp * evaluate_node(G, node.data_id, combined_dictionary[node.data_id], combined_dictionary)
        total = total + tmp
